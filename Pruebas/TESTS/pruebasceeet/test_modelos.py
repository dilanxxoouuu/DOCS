...
class TestPagoModel:
    ...
    def test_estado_default(self, session):
        ...
        usuario = Usuario(id_usuario=999, nombre="Test User", numerodoc="123456789", correo="default@gmail.com", contrasena="12345678") # Ajusta según tu modelo Usuario
        session.add(usuario)
        session.commit() 
...
class TestPaypalDetalleModel:
    ...
    def test_creacion_paypal_valido(self, session):
        ...
        carrito = Carrito(id_carrito=20, id_usuario=999, total=750)
        pago = Pago(
            id_carrito=carrito.id_carrito,
            monto=750,
            metodo_pago='paypal'
    ...
    def test_relacion_unica_con_pago(self, session):
        ...
        carrito = Carrito(id_carrito=21, id_usuario=999, total=800)
...
class TestTransferenciaDetalleModel:
    ...
    def test_creacion_transferencia_valida(self, session):
        ...
        carrito = Carrito(id_carrito= 23, id_usuario=999, total=1200)
        pago = Pago(
            id_carrito=carrito.id_carrito,
            monto=1200,
            metodo_pago='transferencia'
...
class TestTarjetaDetalleModel:
    ...
    def test_creacion_tarjeta_valida(self, session):
        ...
        carrito = Carrito(id_carrito=24, id_usuario=999, total=1500)
        pago = Pago(
            id_carrito=carrito.id_carrito,
            monto=1500,
            metodo_pago='tarjeta'
